SystemJS.config({
  paths: {
    ...
    "postcss-var-replace-playground/": "src/"
  },
  browserConfig: {
    "baseURL": "/",
    "bundles": {
      "build.js": [
        "postcss-var-replace-playground/js/main.js",
        "postcss-var-replace-playground/js/services/PlaygroundPersistentSettingsDAO.js",
        ...
        "postcss-var-replace-playground/js/actions/PlaygroundActions.js",
        "postcss-var-replace-playground/js/constants/PlaygroundConstants.js",
        "npm:keymirror@0.1.1/index.js",
        "npm:keymirror@0.1.1.json",
        "postcss-var-replace-playground/js/dispatcher/AppDispatcher.js",
        ...
        "postcss-var-replace-playground/js/components/PlaygroundApp.js",
        "postcss-var-replace-playground/js/components/EditorTextarea.js",
        ...
        "postcss-var-replace-playground/js/components/PlaygroundHeader.js",
        "npm:object-assign@4.1.1/index.js",
        "npm:object-assign@4.1.1.json",
        "postcss-var-replace-playground/js/stores/PlaygroundStore.js",
        "npm:postcss-var-replace@0.14.0/index.js",
        "npm:postcss-var-replace@0.14.0.json",
        "npm:postcss-var-replace@0.14.0/lib/resolve-decl.js",
        "npm:postcss-var-replace@0.14.0/lib/clone-splice-parent-onto-node-when.js",
        "npm:postcss-var-replace@0.14.0/lib/shallow-clone-node.js",
        "npm:postcss-var-replace@0.14.0/lib/find-node-ancestor-with-selector.js",
        "npm:postcss-var-replace@0.14.0/lib/generate-scope-list.js",
        "npm:postcss-var-replace@0.14.0/lib/generate-descendant-pieces-from-selector.js",
        "npm:postcss-var-replace@0.14.0/lib/is-node-under-scope.js",
        "npm:postcss-var-replace@0.14.0/lib/is-under-scope.js",
        "npm:postcss-var-replace@0.14.0/lib/generate-direct-descendant-pieces-from-selector.js",
        "npm:postcss-var-replace@0.14.0/lib/is-piece-always-ancestor-selector.js",
        "npm:escape-string-regexp@1.0.5/index.js",
        "npm:escape-string-regexp@1.0.5.json",
        "npm:postcss-var-replace@0.14.0/lib/gather-variable-dependencies.js",
        "npm:postcss-var-replace@0.14.0/lib/resolve-value.js",
        ...
        "postcss-var-replace-playground/js/stores/PlaygroundSettingsStore.js",
        "postcss-var-replace-playground/postcss/playground.css",
  ...
  packages: {
    "postcss-var-replace-playground": {
      "main": "main.js",
      "format": "esm",
      "meta": {
        "*.js": {
...
SystemJS.config({
  ...
  map: {
    ...
    "postcss-var-replace": "npm:postcss-var-replace@0.14.0",
  ...
  packages: {
    ...
    "npm:postcss-var-replace@0.14.0": {
      "map": {
        "balanced-match": "npm:balanced-match@1.0.0",
